<a href="{{route('products.show', $product)}}">
    <div class="flex flex-col shadow-sm hover:shadow-md gap-2 mx-auto w-56 min-w-[160px] h-60 border border-gray-200 rounded-xl p-8 hover:scale-105 transition ease-in-out duration-150 cursor-pointer hover:border-dotted">
        <div id="image" class="flex justify-center">
            <img class="max-w-28 max-h-28" src="{{asset('images/icons/' . $product->getCategoryIcon())}}" alt="">
        </div>
        <div class="border-b text-xs bold">
